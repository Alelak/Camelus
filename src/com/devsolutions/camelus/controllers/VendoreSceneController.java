...
public class VendoreSceneController implements Initializable{
	@FXML
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		btnAdd.setOnAction(e->{
				 ...
				 commission.getSelectionModel().getSelectedIndex() != 0)
			{
				...
				System.out.println("prenom : " + textFname.getText());
				System.out.println("nom : " + textLname.getText());
				System.out.println("date embauche : " + hireDate.getValue());
				System.out.println("date : " + date);
				System.out.println("NAS  : " + textSin.getText());
				System.out.println("commission : " + commission.getValue());
				System.out.println("*************************************");*/
	...
	public void initData(VendorTableViewController vendorTVConroller){
